...
<footer class="text-center text-lg-start bg-white text-muted">
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" class="text-reset">Rehabilitación postoperatoria</a>
          </p>
          <p>
            <a href="#!" class="text-reset">Terapia de rehabilitación neurológica</a>
          </p>
          <p>
            <a href="#!" class="text-reset">Evaluación y tratamiento de la postura</a>
          </p>
          <p>
            <a href="#!" class="text-reset">Terapia manual</a>
          </p>
        </div>
        <!-- Grid column -->
        ...
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="#!" class="text-reset">Quiero una valoracion</a>
          </p>
          <p>
            <a href="#!" class="text-reset">Como solicitar una cita</a>
          </p>
          <p>
            <a href="#!" class="text-reset">Donde estamos ubicados</a>
          </p>
          <p>
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.025);">
    © 2023 Copyright:
    <a class="text-reset fw-bold">SENA</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->